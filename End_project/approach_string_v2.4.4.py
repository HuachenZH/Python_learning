...
@author: e^(j·2pi)
"""
# v2.4.4 changes in arthmetic_arranger(), i use a system of error flag, now it will check all the errors, then quit the function. In previous version, the function stops when a first error appears
